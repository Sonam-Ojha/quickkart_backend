...
const adminInfoPageRoutes   = require('./src/routes/admin/info-page.routes');
...
app.use('/api/admin/info-pages',  adminInfoPageRoutes);
...
app.use('/api/app/pages',      require('./src/routes/app/info-page.routes'));
